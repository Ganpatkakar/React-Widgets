...
export const checkboxChecked = (width: number = 12, height: number = 12) => (
  <svg fill="currentColor" className="" aria-hidden="true" width={width} height={height} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
...
export const checkboxMixed = (width: number = 12, height: number = 12) => (
  <svg fill="currentColor" className="" aria-hidden="true" width={width} height={height} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4c0-1.1.9-2 2-2h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4Z" fill="currentColor">
    </path>
  </svg>
);