...
function TextSectionComponent() {
  ...
  return (
    <div>
      <div>
        Lorum ipsum Content Lorum ipsum Content Lorum ipsum Content Lorum ipsum
        Content
      </div>
      <button
...
export const carouselList: ICarouselList[] = [
  ...
  },
  {
    ...
    mediaSection: {
      video:
        "https://static.videezy.com/system/resources/previews/000/011/119/original/Videezy_Slideshow_07_Preview.mp4",
    },
  },
  {
    backgroundImage:
