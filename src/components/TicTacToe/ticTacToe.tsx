...
const useGrid = () => {
    const [grid, setGrid]: [any, Dispatch<SetStateAction<any>>] = useState([...gridInitialState]);
    const [player, setPlayer]: [string, Dispatch<SetStateAction<string>>] = useState("x");
    const [gameOver, setGameOver]: [boolean, Dispatch<SetStateAction<boolean>>] = useState(false);

    const manageGrid: (...args: any) => void = (row, col) => {
